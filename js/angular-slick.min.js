...
angular
	...
	.constant("slickCarouselConfig", { method: {}, event: {} })
	.directive("slick", [
		"$timeout",
		"slickCarouselConfig",
		function (e, n) {
							...
							(s = function () {
								r = angular.extend(
									angular.copy(n),
									{
										...
										edgeFriction: t.edgeFriction || 0.15,
							...
							(d = function () {
								...
								(t.internalControl = r.method || {}),
									...
									n.on("afterChange", function (n, i, o) {
										(c = o),
											"undefined" != typeof r.event.afterChange &&
												e(function () {
													t.$apply(function () {
									...
									n.on("beforeChange", function (n, i, o, a) {
										"undefined" != typeof r.event.beforeChange &&
											e(function () {
												e(function () {
													t.$apply(function () {
									...
									n.on("reInit", function (n, i) {
										"undefined" != typeof r.event.reInit &&
											e(function () {
												t.$apply(function () {
													r.event.reInit(n, i);
												});
									...
									"undefined" != typeof r.event.breakpoint &&
										n.on("breakpoint", function (n, i, o) {
											e(function () {
												t.$apply(function () {
									...
									"undefined" != typeof r.event.destroy &&
										n.on("destroy", function (n, i) {
											e(function () {
												t.$apply(function () {
													r.event.destroy(n, i);
												});
									...
									"undefined" != typeof r.event.edge &&
										n.on("edge", function (n, i, o) {
											e(function () {
												t.$apply(function () {
													r.event.edge(n, i, o);
												});
									...
									"undefined" != typeof r.event.setPosition &&
									...
									"undefined" != typeof r.event.swipe &&
										n.on("swipe", function (n, i, o) {
											e(function () {
												t.$apply(function () {
													r.event.swipe(n, i, o);
												});
									...
									"undefined" != typeof r.event.lazyLoaded &&
										n.on("lazyLoaded", function (n, i, o, a) {
											e(function () {
												t.$apply(function () {
									...
									"undefined" != typeof r.event.lazyLoadError &&
										n.on("lazyLoadError", function (n, i, o, a) {
											e(function () {
												t.$apply(function () {
